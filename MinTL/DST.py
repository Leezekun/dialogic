...
def main():
    ...
    if args.mode == 'test':
        ...
        parse_arg_cfg(args)
        if args.model_path=="":
            args.model_path = 'experiments_DST/{}/{}_sd{}_lr{}_bs{}_sp{}_dc{}_cw{}_model_{}_noupdate{}/'.format(args.generated_data_file, '-'.join(cfg.exp_domains), cfg.seed, args.lr, cfg.batch_size,
