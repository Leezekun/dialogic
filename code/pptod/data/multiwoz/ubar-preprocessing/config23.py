...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.vocab_path_train = './data/multi-woz-2.3-processed/vocab'
        self.vocab_path_eval = None
        self.data_path = './data/multi-woz-2.3-processed/'
        ...
        self.domain_file_path = 'data/multi-woz-2.3-processed/domain_files.json'
        self.slot_value_set_path = 'db/value_set_processed.json'
        self.multi_acts_path = 'data/multi-woz-2.3-processed/multi_act_mapping_train.json'
