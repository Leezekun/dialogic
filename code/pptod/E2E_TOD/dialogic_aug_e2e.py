...
def parse_config():
    ...
    parser.add_argument('--length_limit', type=int, help='the length limit of the prompt.')
            ...
            for dial_id, dialog_with_turn_info in base_dialogs_with_turn_info.items():
                ...
                if not simplified_prompt:
                    ...
                    if augment_type == "substitute":
                        ...
                        domain_slot_nums = random.choices([[1, 4, 6], [2, 3, 5], [3, 2, 5]], weights=[0.1, 0.6, 0.3], k=1)[0]
