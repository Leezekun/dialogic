...
GENERAL_TYPO = {
        # type
        "guesthouse":"guest house", "guesthouses":"guest house", "guest":"guest house", "guest hou": "guest house","mutiple sports":"multiple sports",
        "sports":"multiple sports", "mutliple sports":"multiple sports","swimmingpool":"swimming pool", "concerthall":"concert hall",
        "multisport": "multiple sports",
        ...
        # area
        "center":"centre", "centr": "centre", "cen": "centre", "center of town":"centre", "near city center":"centre", "in the north":"north", "cen":"centre", "east side":"east",
        ...
        "centre of town":"centre", "cb30aq": "none", "cabridge": "cambridge",
        # price
        ...
        # others
        "dont care": "dontcare", "dontcar": "dontcare",
...
def remove_not_mentioned_name(previous_context, target_belief):
    clean_target_belief = []
    context = " ".join(previous_context)
    for tgt in target_belief:
        ...
        if slot == "name":
            if val in context:
                clean_target_belief.append('{} {} {}'.format(domain, slot, val))
        else:
            clean_target_belief.append('{} {} {}'.format(domain, slot, val))
...
def default_cleaning(pred_belief, target_belief):
    ...
    for pred in pred_belief:
        ...
        if re.match("the ", val):
            norm_val = val[4:]
            if '{} {} {}'.format(domain, slot, norm_val) in target_belief:
                val = norm_val
        if re.match("next ", val):
            norm_val = val[5:]
            if '{} {} {}'.format(domain, slot, norm_val) in target_belief:
                val = norm_val
