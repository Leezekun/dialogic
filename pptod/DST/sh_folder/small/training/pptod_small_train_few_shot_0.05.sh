CUDA_VISIBLE_DEVICES=2 python ../../../learn.py\
    ...
    --ckpt_save_path ../../../ckpt23/small/few_shot_0.05/2_shot_augx2\
    --epoch_num 100\
    ...
    --aug_train_data_file multi-woz-fine-processed-train-2_shot_augment_x2_dst_turn_info_train_ratio_0.05.json